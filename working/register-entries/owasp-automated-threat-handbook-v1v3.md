...
- **Source URL or path**: `/mnt/user-data/uploads/SRC-027-owasp-automated-threat-handbook-v1v3.pdf` (archived upload). Canonical project page: https://owasp.org/www-project-automated-threats-to-web-applications/ ; InDesign/PDF sources: https://github.com/OWASP/www-project-automated-threats-to-web-applications/tree/master/assets/files/EN

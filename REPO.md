...
| Public URL | `https://clearbranch.github.io/openbotrisk/` on GitHub Pages | Stable URL, simple setup |
...
- [ ] Confirm `https://clearbranch.github.io/openbotrisk/` as the public GitHub Pages URL

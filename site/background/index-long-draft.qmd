...
Automated traffic is now a normal operating condition for websites, not a fringe case. Vendor telemetry puts bots at roughly half of web traffic, with a substantial share classified as bad-bot activity (Thales/Imperva 2026). These figures should be read carefully: they come from infrastructure-provider visibility, with opaque sampling and classification, not from a neutral census of the whole internet. But they are enough to justify the project's starting point: public web services are no longer serving only human users.
...
This background section maps that landscape. It sets out the threat vocabulary, the adversary model, the economics of automation, the commercial defender landscape, and the AI-agent shift. It also marks the limits of the evidence: the corpus is much stronger on capability and market existence than on independent measurement of prevalence or defensive effectiveness.

## What this section covers

This section is the project’s map of the bot-abuse landscape.

- **The threat model** defines the problem as automated activity at scale against systems built for human users. It uses OWASP Automated Threats to Web Applications as the main vocabulary for naming abuse types.
- **The booking-style example** grounds the discussion in a practical system: ticketing, appointments, reservations, or other scarce-inventory services.
- **The adversary section** describes attackers by motivation and capability, not by named groups. The useful distinction is not “who are they?” but “what are they trying to do, and how sophisticated is their automation?”
- **The economics section** looks at the cost structure of automation: tooling, proxies, CAPTCHA solvers, cloud browsers, and managed scraping infrastructure. It does not try to estimate criminal revenue or money flows.
- **The commercial defender landscape** treats vendor material as evidence about how the field describes itself: bot scores, behavioural signals, device fingerprints, challenges, intent-based detection, proof-of-execution, and managed bot protection. It does not rank vendors or treat marketing claims as independent proof.
- **The AI-agent shift** explains why the old boundary between “human user” and “bot” is weakening. Browser-native automation and AI agents can act through real browsers and legitimate sessions, so the harder question becomes what the automation is doing and whether it should be allowed.
